...
//         let curItem = this.state.items[this.index];
...
//
//         // let upViewStyle = { marginTop: (2 - index) * 30, height: length * 30, };
//         // let middleViewStyle = { marginTop: -index * 40, };
//         // let downViewStyle = { marginTop: (-index - 1) * 19, height: length * 30, };
//
//         let upViewStyle = {
