                    ...
                    <View style={{flex: 1, backgroundColor:'white'}}>
                        <View style={{height:47, flexDirection: 'row', alignItems: "center", justifyContent: "space-between",}}>
                            <View style={{flexDirection: 'row'}}>
                                ...
                                <Text style={{fontSize:appFontFit(10), color:appData.appSecondaryTextColor, marginLeft:5}}>{'货物编号：' + info.item.goods_sn}</Text>
                            </View>
                            <View style={{marginRight:16, justifyContent: "flex-end"}}>
                                <Text style={{fontSize:appFontFit(12), color:appData.appBlueColor}}>{'已有' + info.item.offer_num + '人报价'}</Text>
                            </View>
                        </View>
                        ...
                        <View style={{marginRight:16, height:30, flexDirection: 'row',  alignItems: "center", justifyContent: "flex-end"}}>
                            <Text style={{fontSize:appFontFit(11), color:appData.appSecondaryTextColor}}>{(this.props.showCreateTime ? info.item.create_timetext + ' ' : '') + '浏览'+ info.item.view_num + ' 收藏' + info.item.collect_num}</Text>
                        </View>
                    </View>
                </TouchableHighlight>
